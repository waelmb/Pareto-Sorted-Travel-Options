...
int main(int argc, char *argv[]) {
  ...
  START("[insert_pareto_sorted] second round of insert_pareto_sorted tests");

  TEST_RET_MESSAGE(t_insert_kill_some(),  "new option added & eliminates some, but not all options after it", true, 2.8); 
  TEST_RET_MESSAGE(t_insert_kill_all(),  "new option added & eliminates ALL existing options", true, 2.8); 
  TEST_RET_MESSAGE(t_insert_added_and_nokill(),  "new option added & all existing options remain", true, 2.8); 
